...
ClapTrap::ClapTrap(): _name("Clap Default"), _ep(10), _hp(10), _ad(0) {
    std::cout << "ClapTrap default constructor called\n";
}

ClapTrap::ClapTrap(std::string const name): _name(name), _ep(10), _hp(10), _ad(0) {
    std::cout << "ClapTrap with name " << this->_name << " constructor called\n";
